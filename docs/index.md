...
This handbook reconciles two different kinds of evidence:

- the repository describes the current single-tag software baseline;
- the July 2026 final report describes the physical prototype, experiments, trade-offs, and incidents.

Where they differ, the pages explicitly label a statement as **flight-tested**, **bench-verified**, **implemented in software**, or **planned**. This prevents a successful software transaction test from being mistaken for a completed autonomous flight.
